...
export default function FilterTutors({ onFilterChange, onReset }: FilterTutorsProps) {
  ...
  useEffect(() => {
    const fetchDistrictsData = async () => {
      try {
        const response = await fetch('https://gist.githubusercontent.com/sifatulrabbi/9c1ae990e905bf620af298b5a4489f68/raw/4d9596fc0e0e48c223dea79efe902f6478e70cfd/bd_districts_areas.json');
  ...
  useEffect(() => {
    if (district && district !== 'all') {
      const selectedDistrict = districtsData.find(d => d.district.toLowerCase() === district.toLowerCase());
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={area} onValueChange={setArea} disabled={district === 'all'}>
              <SelectTrigger className="w-full">
